...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blog Pessoal do Aleff").description("Projeto API Spring - Blog Pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/aleffqs")
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Aleff Santos", "https://github.com/aleffqs", "aleffqs@hotmail.com");
	}
